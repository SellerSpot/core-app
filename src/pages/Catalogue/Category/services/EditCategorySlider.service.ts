...
import { IEditCategoryForm } from '../Components/CategoryView/Components/EditCategorySlider/EditCategory.types';
    ...
    static validateField = (props: {
        ...
        try {
            ...
            if (fieldName === 'categoryName') {
                const isInvalidName = CategoryService.isThereASibilingNodeWithSameTitle({
