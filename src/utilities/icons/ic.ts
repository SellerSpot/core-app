...
export { default as outlineFullscreen } from '@iconify/icons-ic/outline-fullscreen';
...
export { default as outlineNotifications } from '@iconify/icons-ic/outline-notifications';
